...
from app.monitoring_agent.tools.prometheus_tool import get_metrics_of_namespace
...
class MonitoringAssistantCrew():
    ...
    def __init__(self) -> None:
        ...
        self.get_metrics_of_namespace = get_metrics_of_namespace
        self.agents = [
    ...
    def metrics_analyser(self):
        return Agent(config=self.agents_config['metrics_analyser'], llm=self.llm, tools=[self.get_metrics_of_namespace])
